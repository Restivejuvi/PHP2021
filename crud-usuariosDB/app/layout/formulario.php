...
<table>
 ...
 <td>
 <input type="text" 	name="PRODUCTO_NO" 	value="<?=$prod->PRODUCTO_NO ?>"       <?= ($orden == "Detalles")?"readonly":"" ?> size="20" autofocus></td></tr>
 <tr><td>DESCRIPCION   </td> <td>
 <input type="text" 	name="DESCRIPCION" 	value="<?=$prod->DESCRIPCION ?>"        <?= ($orden == "Detalles" || $orden == "Modificar")?"readonly":"" ?> size="8"></td></tr>
